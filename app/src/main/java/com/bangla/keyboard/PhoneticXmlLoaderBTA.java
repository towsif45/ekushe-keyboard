...
public class PhoneticXmlLoaderBTA implements PhoneticLoader {

    private URL url = null;
    InputStream in = null;

    public PhoneticXmlLoaderBTA(Context context) {
    ...
    public PhoneticXmlLoaderBTA(Context context, boolean flag) {
        AssetManager assetManager = context.getAssets();
        try {
            if(flag == true)
                in = assetManager.open("phonetic.xml");
    ...
    public PhoneticXmlLoaderBTA(String path) throws MalformedURLException {
